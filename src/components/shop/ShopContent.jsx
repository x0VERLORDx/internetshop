...
const ShopContent = () => {
  ...
  */
      const allProducts = [
        { id: 1, name: 'Футболка USA', price: 129, image: img1 },
        { id: 2, name: 'Купальник Glow', price: 150, image: img2 },
        { id: 3, name: 'Світшот Sweet Shot', price: 200, image: img3 },
        { id: 4, name: 'Футболка USA', price: 129, image: img1 },
        { id: 5, name: 'Купальник Glow', price: 150, image: img2 },
        { id: 6, name: 'Світшот Sweet Shot', price: 200, image: img3 },
        { id: 7, name: 'Футболка USA', price: 129, image: img1 },
        { id: 8, name: 'Купальник Glow', price: 150, image: img2 },
        { id: 9, name: 'Світшот Sweet Shot', price: 200, image: img3 },
        { id: 7, name: 'Футболка USA', price: 129, image: img1 },
        { id: 8, name: 'Купальник Glow', price: 150, image: img2 },
        { id: 9, name: 'Світшот Sweet Shot', price: 200, image: img3 },
        { id: 10, name: 'Футболка USA', price: 129, image: img1 },
        { id: 11, name: 'Купальник Glow', price: 150, image: img2 },
        { id: 12, name: 'Світшот Sweet Shot', price: 200, image: img3 },
      ];
