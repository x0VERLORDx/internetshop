...
public class Main {
    public static void main(String[] args) {
        ...
        try (Connection con = DriverManager.getConnection(url, user, password)) {
            ...
            File imgFile = new File("C:\\Users\\OVERLORD\\IdeaProjects\\InternetShop\\src\\img\\colection\\colection1.png");
            FileInputStream fis = new FileInputStream(imgFile);

            pst.setLong(1, 10L); // id is set to 1 for example
            pst.setString(2, "Футболка USA"); // product name
            pst.setDouble(3, 129); // product price
